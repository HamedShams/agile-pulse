...
func NewTelegramClient(cfg Config, logger zerolog.Logger) *TelegramClient { return &TelegramClient{ token: cfg.TelegramToken, http: &http.Client{ Timeout: cfg.HTTPTimeout }, log: logger } }
